...
const CalendarDays = ({ year, month, schedules, handleScheduleClick, handleDayClick }: CalendarDaysProps) => {
  ...
  return (
    <BodyContainer>
      {calendarDays().map(({ day, date, isToday, isCurrentMonth, schedules }, index) => (
        <DayContainer
          key={index}
          $isToday={isToday}
          style={{
